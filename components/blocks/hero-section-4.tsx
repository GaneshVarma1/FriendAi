...
export function HeroSection() {
    return (
        <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
            {/* Header */}
            <header className="w-full py-6 flex items-center justify-center z-20 fixed top-0 left-0 bg-transparent">
                <h2 className="text-2xl font-bold tracking-tight text-foreground mx-auto">Friend AI</h2>
            ...
            <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-3xl mx-auto text-center">
                <div className="mx-auto text-center">
                    <h1 className="mt-8 text-balance text-5xl font-bold md:text-6xl lg:mt-16 xl:text-7xl">
                        Your AI Friend, Always Here
                    </h1>
                    <div className="text-xs text-muted-foreground text-center mt-2 mx-auto font-bold">
                    ...
                    <p className="mt-6 text-lg text-muted-foreground">Experience meaningful conversations with an AI companion that&apos;s ready to chat, listen, and be there whenever you need a friend.</p>
                    <SignedOut>
            ...
            {/* Marquee Text */}
            <div className="w-full absolute bottom-0 left-0 z-20 overflow-hidden" style={{background: 'transparent'}}>
                <div className="whitespace-nowrap animate-marquee text-lg font-medium py-3 text-foreground" style={{opacity: 0.30}}>
                    <span className="mx-8">Chatting with Priya</span>
                    <span className="mx-8">In text with Alex</span>
                    <span className="mx-8">Conversation with Maya</span>
                    <span className="mx-8">Helping Arjun</span>
                    <span className="mx-8">Supporting Emma</span>
                    <span className="mx-8">Chatting with Zoe</span>
                    <span className="mx-8">In text with Daniel</span>
                    <span className="mx-8">Conversation with Sam</span>
                    <span className="mx-8">Helping Olivia</span>
                    <span className="mx-8">Supporting Liam</span>
                    <span className="mx-8">Chatting with Priya</span>
                    <span className="mx-8">In text with Alex</span>
                </div>
            </div>
...
const menuItems = [
    { name: 'Voice Chat', href: '/call' },
    { name: 'Text Chat', href: '/message' },
